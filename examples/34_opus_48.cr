...
# Claude Opus 4.8 example: frontier-intelligence agent model
#
# Demonstrates features shipped with the Opus 4.8 release (May 2026):
# - The `CLAUDE_OPUS_4_8` model id (rolling `CLAUDE_OPUS` alias now points here)
...
#
# Run with:
#   crystal run examples/34_opus_48.cr

Dotenv.load if File.exists?(".env")

client = Anthropic::Client.new

puts "Claude Opus 4.8"
puts "=" * 60
puts

# --- 1. Direct Opus 4.8 call ---
puts "1. Basic call with CLAUDE_OPUS_4_8"
puts "-" * 60
puts
...
puts "2. xhigh effort level (Opus 4.8)"
puts "-" * 60
puts
...
# NOTE: `task_budget` is part of the Opus 4.8 release and may require a
...
begin
  message = client.beta.messages.create(
    ...
    messages: [{role: "user", content: "Summarize the benefits of opus 4.8 in three bullet points."}]
  )
